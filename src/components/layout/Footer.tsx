      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-gray-600 text-sm">
              Connect with industry, commerce, and technology experts for professional consultations and services.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/experts" className="text-base text-gray-500 hover:text-primary">
                  Find Experts
                </Link>
              </li>
              <li>
                <Link to="/become-expert" className="text-base text-gray-500 hover:text-primary">
                  Become an Expert
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/how-it-works" className="text-base text-gray-500 hover:text-primary">
                  How it Works
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/careers" className="text-base text-gray-500 hover:text-primary">
                  Careers
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-200 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Expertsaas. All rights reserved.
          </p>
